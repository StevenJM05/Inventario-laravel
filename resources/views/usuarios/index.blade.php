...
@section('content')
    <div class="container m-5">
        <div class="card">
            ...
            <div class="card-body">
                <button class="btn btn text-white bg-dark mb-3" data-bs-toggle="modal" data-bs-target="#createModal">Agregar Usuario</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header bg-dark text-white">
                                            <h5 class="modal-title" id="updateModalLabel{{ $user->id }}">Actualizar Usuario</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('users.update', $user->id) }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    <label for="rol{{ $user->id }}" class="form-label">Rol del usuario</label>
